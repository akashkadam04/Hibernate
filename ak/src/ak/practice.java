...
class practice{
	public static void main(String[] args) {
		...
		HashMap<Integer,String> m = new HashMap(); //It follows insertion order somtimes or sort the elements sometimes..we cannot give guarntee of it 
		m.put(1, "Ak");   
		m.put(3, "Bk");
		m.put(2, "Ck");
		System.out.println(m);
		
		LinkedHashMap<Integer,String> m1 = new LinkedHashMap();  //It follows insertion order...does not sort elements..
		m1.put(3, "River");
		m1.put(1, "Mountain");
		m1.put(2, "Lake");
		System.out.println(m1);
		
		TreeMap<Integer,String> m2 = new TreeMap();   //It also sorted elements
		m2.put(1, "Ak");
		m2.put(3, "Bk");
		m2.put(2, "Ck");
